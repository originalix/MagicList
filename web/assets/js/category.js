        ...
        category.refreshData = function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                html += "<div class='list-content hide' id= " +
                    data[i].id +
                    "<a href='#' class='list-link'> <ddiv class='product-list-icon-block'> <i class='product-left-icon iconfont'>&#xe67d;</i> <i class='product-center-icon iconfont'>&#xe636;</i> <i class='product-right-icon iconfont'>&#xe603;</i> </ddiv> <div class='list-title-block product-list-title-block'> <div class='product-list-seprate'> <i class='list-name-icon iconfont'>&#xe693;</i> <p class='product-list-title product-name'>" +
                    data[i].name +
